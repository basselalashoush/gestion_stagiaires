    ...
    <tbody >
        ...
        foreach ($stagiaires as $stagiaire) :
            ...
            <tr> 
                ...
                <td  id="<?= $stagiaire->id_formation; ?>" data-stagiaire="<?= $idStagiaire;?>" class="formation"><?= $label; ?></td>
                <?php
                $p = explode(',',$period );?>
               <td>
               ...
               ?>
                <input type="checkbox" id="scales"  name="scales" <?=$attribute;?> data-id ="<?= $idStagiaire;?>"
                   dtat_periode="<?=$data->id_periode; ?>" data-formation = "<?=$data->id_formation;?>" ><span><?=$data->formateurPeriode;?></span></br>
               <?php endforeach;?>
                </td>
                <td><a href=""><i class="fas fa-eye" title="Afficher"></i></a>
                    &emsp; <a href="index.php?uc=stagiaire&action=updateStagiaire&id_stagiaire=<?= $idStagiaire;?>"><i class="fas fa-edit" title="Modifier"></i></a>
